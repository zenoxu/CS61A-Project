...
def hefty_hogs(player_score, opponent_score):
    ...
    if opponent_score == 0:
        ...
        result = digit_fn(opponent_score % 10)(player_score)
        opponent_score = opponent_score//10
        while opponent_score//10 != opponent_score:
            result = digit_fn(opponent_score % 10)(result)
            opponent_score = opponent_score // 10
        return result % 30
    # END PROBLEM 2
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            who = 0
        leader, messager = say(score0, score1, leader)
        if (messager != None) and (messager != ""):
            print(messager)
...
def announce_lead_changes(score0, score1, last_leader=None):
    ...
    if score1 < score0:
        ...
        leader = None
    if leader != last_leader and score1 != score0:
        if leader == 1:
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    "*** YOUR CODE HERE ***"
    # initialize
    max_score, max_score_num, i = 0, -1, 1
    while i <= 10:
        max_score_i = make_averaged(roll_dice, total_samples)(i, dice)
...
def hog_pile_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    hog_points = hog_pile(score+hefty_points, opponent_score)
    if hog_points != 0:
        return 0
    elif hog_points + hefty_points >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
